            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              {isAuthenticated ? (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Link 
                    to="/register" 
                    className="bg-ghana-green text-white px-4 py-2 rounded-lg hover:bg-ghana-green/90"
                  >
                    Get Started
                  </Link>
                </div>
            ...
            <div className="px-4 py-3 space-y-3">
              ...
              {isAuthenticated ? (
                ...
                <>
                  <Link 
                    to="/login" 
                    className="block py-2 text-ghana-green"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Login
                  </Link>
                  <Link 
                    to="/register" 
                    className="block py-2 bg-ghana-green text-white rounded-lg text-center"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Get Started
                  </Link>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
            ...
            <p className="mt-2">Licensed by Bank of Ghana</p>
          </div>
        </div>
      </footer>
    </div>
